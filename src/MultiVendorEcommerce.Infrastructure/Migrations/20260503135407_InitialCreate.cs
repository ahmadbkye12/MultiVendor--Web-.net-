        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VendorStoreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignedDeliveryUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shipments_VendorStores_VendorStoreId",
                        column: x => x.VendorStoreId,
                        principalTable: "VendorStores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    VendorNetAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    VendorFulfillmentStatus = table.Column<int>(type: "int", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_VendorStoreId",
                table: "Products",
                column: "VendorStoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_VendorStoreId",
                table: "Shipments",
                column: "VendorStoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorStores_VendorId",
                table: "VendorStores",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_CustomerUserId_ProductId",
                table: "WishlistItems",
